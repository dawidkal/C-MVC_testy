                ...
                c => new
                    {
                        ...
                        Imie = c.String(nullable: false, maxLength: 60),
                        Nazwisko = c.String(nullable: false, maxLength: 60),
                        Ulica = c.String(nullable: false, maxLength: 60),
                        Miasto = c.String(nullable: false, maxLength: 60),
                        KodPocztowy = c.String(nullable: false, maxLength: 60),
                        Telefon = c.String(),
                        Email = c.String(),
                        Komentarz = c.String(),
                        DataDodania = c.DateTime(nullable: false),
